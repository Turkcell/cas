 ...
 * under the License.
 */
package com.turkcell.cas.oauth.web.flow;
 ...
 * other OAuth parameters are expected after OAuth authentication. Providers are
 * defined by configuration. The {@link org.jasig.cas.support.oauth.OAuthConstants.SERVICE},
 * {@link org.jasig.cas.support.oauth.OAuthConstants.THEME}, {@link org.jasig.cas.support.oauth.OAuthConstants.LOCALE}
 * and {@link org.jasig.cas.support.oauth.OAuthConstants.METHOD} parameters are
...
public final class OAuthAction extends AbstractAction {
    ...
    private static final String OAUTH_CREDENTIALS = "oAuthCredentials";
    @NotNull
    ...
    protected Event doExecute(final RequestContext context) throws Exception {
        ...
        if (StringUtils.isNotBlank(providerType)) {
            ...
            try {
                ...
                context.getFlowScope().put(OAUTH_CREDENTIALS, credentials);
                return success();
