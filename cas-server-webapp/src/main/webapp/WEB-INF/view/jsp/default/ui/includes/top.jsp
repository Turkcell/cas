    ...
    <header class="site-header">
        <div class="content-holder">
            ...
            <nav id="page-navigation" class="primary-navigation group" role="navigation">
                <ul class="nav group">
                    <li class="first <c:out value='${signup ? "" : "active"}'/>"><a href="/cas/login" class="<c:out value='${signup ? "" : "active"}'/>">Giriş Yap</a></li>
                    <li class="last <c:out value='${signup ? "active" : ""}'/>"><a href="/cas/signup" class="<c:out value='${signup ? "active" : ""}'/>">Kayıt Ol</a></li>
                </ul>
            </nav>
        </div>
    </header>
